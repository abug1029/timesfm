#!/bin/bash
# Phase 10 JD/I/P 剩余 backtest (9 作业, 排除 JD baseline 和 JD-A)
# 用法: bash scripts/phase10_backtest_jd_i_p_remaining.sh

set -e
source D:/FlyBuddy/shared/timesfm/.venv/Scripts/activate
cd D:/FlyBuddy/fm_a

echo "=== Phase 10 JD/I/P 剩余 backtest (9 作业) ==="
echo "开始时间: $(date)"
echo ""
...
# P 4 个 (排除 P baseline, 已在 phase10_backtest_jd_i_p.sh 中)
