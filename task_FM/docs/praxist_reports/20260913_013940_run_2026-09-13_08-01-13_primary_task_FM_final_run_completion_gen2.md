# Praxist Run Report: run_2026-09-13_08-01-13_primary_task_FM

- Generated at: `2026-09-13T01:39:40Z`
- Trigger: `final_run_completion`
- Generation context: `2`
- Report kind: `frontier_lineage_health`
- Run directory: `/home/abug/timesfm/task_FM/experiments/run_2026-09-13_08-01-13_primary_task_FM`
...
Comparative claims and charts were omitted for metrics with unknown or conflicting direction: `calendar_failures`, `ccl_failures`, `econ_pass_count`, `ha_body_failures`, `m_ccl_ev`, `m_ccl_ic`, `m_ccl_pf`, `n_required`, `nvi_failures`, `oi_failures`, `predicted_pf`, `sr_oi_ev`, `sr_oi_ic`, `sr_oi_pf`, `total_tested`.
...
A companion PDF is written next to this Markdown file at `/home/abug/timesfm/task_FM/docs/praxist_reports/20260913_013940_run_2026-09-13_08-01-13_primary_task_FM_final_run_completion_gen2.pdf`.
