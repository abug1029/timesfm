# Praxist Run Report: run_2026-09-13_13-53-35_primary_task_FM

- Generated at: `2026-09-13T07:33:04Z`
- Trigger: `final_run_completion`
- Generation context: `2`
- Report kind: `frontier_lineage_health`
- Run directory: `/home/abug/timesfm/task_FM/experiments/run_2026-09-13_13-53-35_primary_task_FM`
...
Comparative claims and charts were omitted for metrics with unknown or conflicting direction: `dead_count`, `econ_pass_count`, `hard_gate_losing_count`, `ic_gate_target`, `n_available`, `n_required`, `non_volatility_positive_ev_count`, `predicted_pf_target`, `volatility_family_positive_ev_count`.
...
- Structured findings visible: `10`.
...
A companion PDF is written next to this Markdown file at `/home/abug/timesfm/task_FM/docs/praxist_reports/20260913_073304_run_2026-09-13_13-53-35_primary_task_FM_final_run_completion_gen2.pdf`.
