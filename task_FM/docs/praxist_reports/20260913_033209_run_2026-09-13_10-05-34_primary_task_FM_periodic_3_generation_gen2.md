# Praxist Run Report: run_2026-09-13_10-05-34_primary_task_FM

- Generated at: `2026-09-13T03:32:09Z`
- Trigger: `periodic_3_generation`
- Generation context: `2`
- Report kind: `frontier_lineage_health`
- Run directory: `/home/abug/timesfm/task_FM/experiments/run_2026-09-13_10-05-34_primary_task_FM`
...
Comparative claims and charts were omitted for metrics with unknown or conflicting direction: `dead_count`, `econ_pass_count`, `jd_ev`, `jd_ic`, `jd_pf`, `lh_ev`, `lh_ic`, `lh_pf`, `n_expected`, `n_required`, `predicted_ev`, `predicted_pf`, `prior_sr_calendar_ic`, `symbols_with_positive_ev`, `variants_tested_jd`, `variants_tested_lh` and others.
...
- Structured findings visible: `44`.
...
A companion PDF is written next to this Markdown file at `/home/abug/timesfm/task_FM/docs/praxist_reports/20260913_033209_run_2026-09-13_10-05-34_primary_task_FM_periodic_3_generation_gen2.pdf`.
