# Praxist Run Report: run_2026-09-09_00-19-43_primary_task_FM

- Generated at: `2026-09-09T01:55:31Z`
- Trigger: `final_run_completion`
- Generation context: `2`
- Report kind: `frontier_lineage_health`
- Run directory: `/home/abug/timesfm/task_FM/experiments/run_2026-09-09_00-19-43_primary_task_FM`
...
Comparative claims and charts were omitted for metrics with unknown or conflicting direction: `DA`, `IC`, `expected_pf`, `gate_required`, `n_available`, `n_expected`, `n_samples`, `predicted_ev`, `predicted_pf`, `prior_ev`, `track_economic_pf`, `track_pf`.
...
- Structured findings visible: `22`.
...
A companion PDF is written next to this Markdown file at `/home/abug/timesfm/task_FM/docs/praxist_reports/20260909_015531_run_2026-09-09_00-19-43_primary_task_FM_final_run_completion_gen2.pdf`.
