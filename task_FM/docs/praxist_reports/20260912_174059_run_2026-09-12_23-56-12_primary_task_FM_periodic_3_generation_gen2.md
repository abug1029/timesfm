# Praxist Run Report: run_2026-09-12_23-56-12_primary_task_FM

- Generated at: `2026-09-12T17:40:59Z`
- Trigger: `periodic_3_generation`
- Generation context: `2`
- Report kind: `frontier_lineage_health`
- Run directory: `/home/abug/timesfm/task_FM/experiments/run_2026-09-12_23-56-12_primary_task_FM`
...
Comparative claims and charts were omitted for metrics with unknown or conflicting direction: `best_ic_pass`, `best_pf_pass`, `gate_pass_rate`, `ic_ratio_ss_m`, `m_vor_ev`, `m_vor_ic`, `m_vor_pf`, `n_dead`, `n_econ_pass`, `n_hard_gate_losing`, `n_required`, `n_samples`, `n_total_verdicts`, `pass_rate`, `prior_evidence_i_oi`, `prior_evidence_m_vor` and others.
...
- Structured findings visible: `59`.
...
A companion PDF is written next to this Markdown file at `/home/abug/timesfm/task_FM/docs/praxist_reports/20260912_174059_run_2026-09-12_23-56-12_primary_task_FM_periodic_3_generation_gen2.pdf`.
